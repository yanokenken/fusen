...
func (checkpointL) LoadFusen(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCheckpoint interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args = append(args, object.FusenID)
...
func (o *Checkpoint) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"checkpoints\"", updateOnConflict, ret, update, conflict, insert)
