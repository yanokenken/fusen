...
var BoardWhere = struct {
	...
	IsPublic:  whereHelperbool{field: "\"boards\".\"is_public\""},
...
var (
	boardAllColumns            = []string{"id", "user_id", "name", "is_public", "created_at", "updated_at"}
	boardColumnsWithoutDefault = []string{"id", "user_id", "name"}
	boardColumnsWithDefault    = []string{"is_public", "created_at", "updated_at"}
