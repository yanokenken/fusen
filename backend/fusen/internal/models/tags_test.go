...
var (
	tagDBTypes = map[string]string{`ID`: `integer`, `UserID`: `integer`, `Name`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_          = bytes.MinRead
)
