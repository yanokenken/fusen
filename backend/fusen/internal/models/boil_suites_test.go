...
func TestParent(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTags)
...
func TestDelete(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsDelete)
...
func TestQueryDeleteAll(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsQueryDeleteAll)
...
func TestSliceDeleteAll(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsSliceDeleteAll)
...
func TestExists(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsExists)
...
func TestFind(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsFind)
...
func TestBind(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsBind)
...
func TestOne(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsOne)
...
func TestAll(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsAll)
...
func TestCount(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsCount)
...
func TestHooks(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsHooks)
...
func TestInsert(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsInsert)
	t.Run("FusensTags", testFusensTagsInsertWhitelist)
...
func TestReload(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsReload)
...
func TestReloadAll(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsReloadAll)
...
func TestSelect(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsSelect)
...
func TestUpdate(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsUpdate)
...
func TestSliceUpdateAll(t *testing.T) {
	...
	t.Run("FusensTags", testFusensTagsSliceUpdateAll)
